...
const TutorialButton: React.FC<TutorialButtonProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-[5.5rem] right-8 z-[55] h-12 w-12 rounded-full backdrop-blur-sm shadow-lg border hover:scale-110 focus:outline-none focus:ring-2 focus:ring-opacity-75 transition-all duration-300 font-extrabold text-2xl leading-none ${ringClass} ${
